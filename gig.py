...
def my_gigs(id):
	sql = "SELECT K.keikka_id, K.nimi, to_char(K.pvm, 'DD/MM/YYYY'), to_char(K.aika, 'HH24:MI'), K.paikka, K.kuvaus, K.kokoonpano FROM keikka K, kokoonpano Ko WHERE ko.users_id=:id AND K.keikka_id = Ko.keikka_id ORDER BY K.pvm, K.aika"
